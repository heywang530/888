...
// let DealStoreShop = deal(ShoppingCar);
...
export default class Home extends Component {
	...
	// 创建卡片方法
	createCard() {
		return this.state.data && this.state.data.map(item => <Card key={item._id} {...item}></Card>)
	}


	render() {
		return (
			<div className="home-page" style={{ paddingBottom: 50 }}>
				{/* 实现Swiper组件 */}
